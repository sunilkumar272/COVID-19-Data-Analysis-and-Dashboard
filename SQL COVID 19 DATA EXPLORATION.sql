...
/*Query to get the infected percentage of the population in the world based on date*/

SELECT Location, Population, Max(total_cases) As InfectedCount, Max((total_cases/population))*100 as InfectionPercentage
FROM CovidDeathData
...
/*Query to get total vaccination percentage across all the countries according to date*/
